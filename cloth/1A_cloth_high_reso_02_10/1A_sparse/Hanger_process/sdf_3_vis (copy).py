...
fig = go.Figure(data=[go.Scatter3d(x=grid_position[:,0], y=grid_position[:,1], z=grid_position[:,2],
                                   mode='markers',marker=dict(
        size=3,
        color=sdf,                # set color to an array/list of desired values
...
trace2 = go.Scatter3d(
    ...
    y=points[:,1],
    z=points[:,2],
    mode='markers',marker=dict(size=3.0))
