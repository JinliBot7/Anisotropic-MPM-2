...
sampled_point = pcd.sample_points_uniformly(number_of_points= 1000000)
...
points_np *= maximum_length * 1/diff
...
sampled_point_np *= maximum_length * 1/diff
# #%%
...
o3d.visualization.draw_geometries([sampled_point])
