...
E, eta = 5e2, 0.3 # Young's modulus, Poisson's ratio
...
# Object
center, dimension = ti.Vector([0.6, 0.5, 0.8]), ti.Vector([0.35, 0.35, 0.0005]) # dimension changes shape. if dimension[i] < e_radius, single layer
    ...
    for p in boundary.sdf:
        ...
        if grid_m[grid_index] != 0:
            ...
            if v_proj < 0:
                ...
                grid_v[grid_index] -= v_normal * boundary.sdf[p] * 1.05
