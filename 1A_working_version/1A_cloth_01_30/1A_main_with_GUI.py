...
# Cloth
name = 'TShirt'
center = ti.Vector([0.5, 0.5, 0.5]) # dimension changes shape. if dimension[i] < e_radius, single layer
#axis_angle = ti.Vector([135 / 180 * pi, 0.0, 0.0, 1.0]) # angle and rotation axis
axis_angle = ti.Vector([135 / 180 * pi, 0.0, 0.0, 1.0]) # angle and rotation axis
