...
axis_angle = ti.Vector([30 / 180 * pi, 1.0, 0.0, 0.0])
...
def Particle_To_Grid(obj:ti.template()):
    ...
    for p in obj.x:
        ...
        # dF_dC = F_plastic.inverse().transpose() @ F_p.transpose()
        ...
        for offset in ti.static(ti.grouped(ti.ndrange(*neighbour))):
            ...
            #grid_v[base + offset] -= weight * 4 * dt * inv_dx * inv_dx * vol * R @ P @ dF_dC @ dpos
