...
N_grid, dt = 256, 1e-4 # Grid number, step time
...
e_radius, total_mass, pho = 0.001, dimension[0] * dimension[1] * dimension[2], 2.0 # e_radius is the radius of the particle. The distance between two particles is defined to 2 * e_radius in Obj Class.
color = (0.5,0.5,0.8)
obj_0 = Obj(center, dimension, axis_angle, e_radius, total_mass, pho, color)

# # Static Boundary Cynlnder Shape
