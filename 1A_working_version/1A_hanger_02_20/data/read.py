...
loss3 = np.load('loss_3.npy')[0:150] * 10e3
loss4 = np.load('loss_4.npy') * 10e3
loss5 = np.load('loss_5.npy')[0:150] * 10e3
...
plt.plot(loss3,'b-',label='learning rate = 300')
plt.plot(loss5,'k-',label='learning rate = 500')
