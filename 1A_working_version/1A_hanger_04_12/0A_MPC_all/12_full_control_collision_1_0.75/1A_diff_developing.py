...
def compute_loss(obj:ti.template(), target:ti.template(), v_input: ti.template(), minimum_index: ti.i32):
    ...
    for p in range(obj.pio_n):
        ...
        loss[None] += dist / obj.pio_n
        loss_position[None] += dist / obj.pio_n
    ...
    for t,p in obj.pio_collision:
            if obj.pio_collision[t,p] == 1.0:
                ...
                if v_proj < 0:
                    ...
                    loss[None] -=  0.75 * dist / (collision_count[None] +1) # +1 to prevent numerical error
                    loss_velocity[None] -= 0.75 * dist / (collision_count[None] +1)
