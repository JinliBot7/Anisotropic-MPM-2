    ...
    for t,p in obj.pio_collision:
            if obj.pio_collision[t,p] == 1.0:
                ...
                if v_proj < 0:
                    ...
                    loss[None] -= obj.pio_coefficient[p] *  0.75 * dist / (collision_count[None] +1) # +1 to prevent numerical error
                    loss_velocity[None] -= obj.pio_coefficient[p] * 0.75 * dist / (collision_count[None] +1)
