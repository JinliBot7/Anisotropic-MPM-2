...
center, dimension = ti.Vector([0.5, 0.5, 0.4]), ti.Vector([0.25, 0.25, 0.004]) # dimension changes shape. if dimension[i] < e_radius, single layer
...
obj_0 = Obj(center, dimension, axis_angle, e_radius, total_mass, pho, color, ini_v)
