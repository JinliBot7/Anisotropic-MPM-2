...
sys.path.append('/home/luyin/Desktop/Anisotropic-MPM-2/garment/0A_paper_iter/Folder_13_new_simu_after_optimization/0_no_hanger/module')
...
N_grid, dt = 128, 2e-4 # Grid number, substep time
...
max_step = 5000 # step per iteration
...
def main():
    ...
    while True:
        ...
        new_obj_center_np = np.array([0.5, np.random.uniform(low = 0.6, high= 0.8), np.random.uniform(low=0.3, high = 0.7)])
        ...
        target_num = np.random.randint(low = 0, high = 10000)
