...
# initialize object
center, dimension = ti.Vector([0.5, 0.8, 0.3]), ti.Vector([0.25, 0.25, 0.0005]) # dimension changes shape. if dimension[i] < e_radius, single layer
    ...
    for p in boundary.sdf:
        ...
        if grid_m[grid_index] != 0:
            ...
            if v_proj < 0:
                ...
                v_out -= v_normal * ti.pow(3,-2*boundary.sdf[p])
                #v_out -= v_tangent * 0.5
