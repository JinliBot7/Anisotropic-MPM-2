...
def main():
    ...
    while True:
        ...
        drag_coe = np.random.uniform(1e-5,1e-3)
        lift_coe = np.random.uniform(1.0,10.0)
        ...
        for t in range(max_step - 1):
            ...
            if t / max_step > next_real_time:
                ...
                #render(t,[obj], [], [path_real], camera, scene, canvas, window, axisX, axisY, axisZ, colorX, colorY, colorZ, line)
                #window.show()
        ...
        #print(loss[None] / (obj.pio_n * n_kf) * 100)
