...
scalar = lambda: ti.field(dtype=real)
vec = lambda: ti.Vector.field(3, dtype=real)
loss, loss_position = scalar(), scalar()
ti.root.place(loss,loss_position)
@ti.kernel
...
def main():
    ...
    while iter_num < max_iter:
        ...
        #visualization
        # if iter_num == 0 or (iter_num + 1) % 1 == 0:
        if iter_num == 172:
            print(iter_num)
        #     print(iter_num)
        #     if iter_num == 0:
        ...
        #     else:
        #         try:
        #             os.mkdir(f'./vis/{iter_num + 1}')
        #         except FileExistsError:
        #             pass
        #             print('fiel alrady exist!')
            
        #     if iter_num == 0:
        #         video_manager = ti.tools.VideoManager(f'./vis/{iter_num }',framerate = 100, automatic_build=False)
        #     else:
        #         video_manager = ti.tools.VideoManager(f'./vis/{iter_num + 1}',framerate = 100, automatic_build=False)
            ...
            print(loss_position[None])

            # if iter_num == 0:
            #     video_manager_2 = ti.tools.VideoManager(f'./vis/{iter_num}_slow',framerate = 50, automatic_build=False)
            # else:
            #     video_manager_2 = ti.tools.VideoManager(f'./vis/{iter_num + 1}_slow',framerate = 50, automatic_build=False)
            ...
            #         window.show()
            #         img = window.get_image_buffer_as_numpy()
            #         video_manager_2.write_frame(img)
            # video_manager_2.make_video(gif=False, mp4=True)  
