...
ti.root.dense(ti.l,max_iter).dense(ti.axes(4),max_step).place(end_effector_right,end_effector_left)
...
def record_end_effector(obj_0:ti.template(), iteration:ti.f32):
    for step in range(max_step):
        end_effector_right[iteration,step] = obj_0.x[step,15]
        end_effector_left[iteration,step] = obj_0.x[step,26]
...
def main():
    ...
    while iter_num < max_iter:
        ...
        record_end_effector(obj, iter_num)
