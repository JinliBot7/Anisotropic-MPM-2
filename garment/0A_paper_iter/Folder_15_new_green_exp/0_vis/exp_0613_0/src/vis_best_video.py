...
sys.path.append('/home/luyin/Desktop/Anisotropic-MPM-2/garment/0A_paper_iter/Folder_15_new_green_exp/module')
...
trial_number = 0
drag_coe = 0.000362463025847492
lift_coe = 6.967215506215731
...
max_step = 30000 # step per iteration
...
def main():
    ...
    time_list = np.load(f'../../../0A_exp_data/{exp_name}/exp_{exp_num}/time.npy')
    ...
    while iter_num <= max_iter:
        ...
        if iter_num == target_iter_num:
            ...
            for t in range(max_step - 1):
                ...
                if t / max_step * 3 > next_real_time / 3.2 * 3.0:
