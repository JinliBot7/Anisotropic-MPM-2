...
def main():
    ...
    path = Path('../asset/target_path', trial_number, (0.5,0.8,0.5), obj.n, obj.pio_n, obj.nx)
    path.initialize()
    ...
    while iter_num <= max_iter:
        ...
        if iter_num == target_iter_num:
            ...
            print('target iter num: ', iter_num)
            ...
            np.save('../data//suc_path/ef_left.npy',end_effector_left_np)
            np.save('../data/suc_path/ef_right.npy',end_effector_right_np)
