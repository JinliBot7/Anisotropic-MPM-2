...
center, dimension = ti.Vector([0.5, 0.5, 0.45]), ti.Vector([0.25, 0.25, 0.0005]) # dimension changes shape. if dimension[i] < e_radius, single layer
axis_angle = ti.Vector([-130 / 180 * pi, 1.0, 0.0, 0.0]) # angle and rotation axis
...
def main():
    ...
    for counter in range(100000):
        ...
        if counter % 100 == 0: 
            ...
            #print('counter: ', counter, 'energy: ',obj_0.energy[0])
            #print(counter)
