...
def main():
    ...
    for trial_num in range(0,400,1):
        ...
        if np.amin(loss) < 2:
            ...
            np.save(f'../suc_path/ef_left_{suc_path_num}.npy',end_effector_left_np)
            np.save(f'../suc_path/ef_right_{suc_path_num}.npy',end_effector_right_np)
            suc_path_num += 1
